...
import LocationIcon from "../../public/assets/cars.svg";
          ...
          <div className="relative bg-slate-600">
            ...
            >
              ...
              <div className="inset-0 top-0 flex justify-center items-center left-0  cursor-pointer opacity-0 hover:opacity-100">
                <div className="relative left-0 bottom-0 text-center right-0  text-sm rounded-md  bg-purple-300 text-white px-4 py-1">
                  {place.name}
                  <div className="absolute left-0 bottom-0 bg-purple-300 w-4 h-2 transform rotate-45"></div>
                </div>
              </div>
            </Marker>
          </div>
